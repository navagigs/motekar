...
<!-- Breadcrumb -->
<div class="page-head">
    <h3>Daftar <small><?php echo $breadcrumb; ?></small></h3>
    <ol class="breadcrumb">
                    ...
                    <form action="" method="post" id="form">
                        <div class='btn-navigation'> 
                            <div class='pull-right'>
                                <a class="btn btn-primary" href="<?php echo site_url();?>pengaturan/kelompok_pengguna/tambah"><i class="fa fa-plus-circle"></i> Tambah Kelompok</a>
                            </div>  
                            <div class='pull-right'>
                                <a class="btn btn-primary" href="<?php echo site_url();?>pengaturan/kelompok_pengguna"><i class="fa fa-times-circle"></i> Bersihkan Pencarian</a>
                            </div>
                        </div>
                        <div class='row'>
                                    ...
                                    <td align="center">
                                        ...
                                        <div class="btn-group">
								            ...
								            <ul class="dropdown-menu pull-right" role="menu">
									            <li>
                                                    <a href="<?php echo site_url();?>pengaturan/kelompok_pengguna/edit/<?php echo $row->admin_level_kode; ?>" title="Edit"><i class='fa fa-pencil'></i> Edit</a>
                                                </li>
                                                <li>
                                                    <a data-toggle="modal" data-target="#mod-info" type="button"  href="<?php echo site_url();?>pengaturan/kelompok_pengguna_detail/<?php echo $row->admin_level_kode;?>" rel="detail" title="Detail <?php echo $row->admin_level_nama; ?>"><i class='fa fa-eye'></i> Detail</a>
                                                </li>
									            <li>
                                                    <a href="javascript:;" data-id="<?php echo $row->admin_level_kode;?>" data-toggle="modal" data-target="#modal-konfirmasi" title="Hapus <?php echo $row->admin_level_nama; ?>"><i class='fa fa-trash-o'></i> Hapus</a>
                                                </li>
								            </ul>
								        </div>	
...
<div class="page-head">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>admin"><i class='fa fa-home'></i> Dashboard</a></li>
        <li><a href="<?php echo base_url();?>pengaturan/kelompok_pengguna"><?php echo $breadcrumb; ?></a></li>
...
<div class="cl-mcont">
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form role="form" class="form-horizontal" action="<?php echo site_url();?>pengaturan/kelompok_pengguna/tambah" method="post" enctype="multipart/form-data" parsley-validate novalidate>
                        <div class="table-responsive">
                            <table class="table no-border hover">
                                ...
                                <tbody class="no-border-y"> 
                                    <tr>
                                        ...
                                        <td>
                                            <input name="admin_level_nama" type="text" required class="form-control input-sm" id="admin_level_nama" value="" size="30" maxlength="30" placeholder="Masukan Nama Kelompok"/>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
<div class="cl-mcont">
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form role="form" class="form-horizontal" action="<?php echo site_url();?>pengaturan/kelompok_pengguna/edit" method="post" enctype="multipart/form-data" parsley-validate novalidate>
                        <input type="hidden" name="admin_level_kode" value="<?php echo $admin_level_kode;?>" />
                        <div class="table-responsive">
                            <table class="table no-border hover">
                                <tbody class="no-border-y">
                                    <tr>
                                        ...
                                        <td>
                                            <input name="admin_level_nama" type="text" required class="form-control input-sm" id="admin_level_nama" value="<?php echo $admin_level_nama; ?>" size="30" maxlength="30" placeholder="Masukan Nama Kelompok"/>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
