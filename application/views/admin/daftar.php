...
<title>LOGIN ADMIN - Motekar</title>
...
<div id="cl-wrapper" class="login-container">
	...
	<div class="middle-login">
		<div class="block-flat">
			...
			<div>
                    <form style="margin-bottom: 0px !important;" class="form-horizontal" action="<?php echo site_url();?>internal/tambah" method="post" name="formLogin" id="form" parsley-validate novalidate>
					<div class="content">
					<!-- ========== Flashdata ========== -->
                    ...
                    <!-- ========== End Flashdata ========== -->
							<div class="form-group input-group-lg">
								<div class="col-sm-12">
                                         <input type="text" name="ukm_nama" id="user" required class="form-control" onblur="clearText(this)" onfocus="clearText(this)" placeholder="Nama UKM" autocomplete="off"/>
							...
							<div class="form-group input-group-lg">
								<div class="col-sm-12">
                                         <input type="text" name="admin_username" id="user" required class="form-control" onblur="clearText(this)" onfocus="clearText(this)" placeholder="Username" autocomplete="off"/>
							...
							<div class="form-group">
								<div class="col-sm-12">
										...
										<input type="password" name="admin_password" id="pass" required class="form-control" onblur="clearText(this)" onfocus="clearText(this)" placeholder="Password" autocomplete="off"/>
									
								</div>
							</div>
						<input type="submit" class="btn btn-primary" name="simpan" value="Daftar"/>
                        <a href="<?php echo site_url();?>internal" class="btn btn-primary" >Login</a>	
					</div>
				</form>
		...
		<div class="text-center out-links"><a href="#">Motekar &copy; <?php echo date('Y'); ?> All Right Reserved</a></div>
        </div>
